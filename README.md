# Python, Django y JavaScript: Sistema de Traducciones, con Bootstrap, DataTables.js y más

Sistema web de traducciones (español - inglés) creado con Python y Django (en el backend) y HTML, CSS y JavaScript (en el frontend, utilizando además el framework CSS Bootstrap y la librería DataTables.js). Aprende a identificar los componentes de una aplicación web completa.
